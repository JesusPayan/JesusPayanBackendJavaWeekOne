...
public class MovieRepositoryIntegrationTest {
    ...
    private String sqlPath ="src/main/java/com/platzi/javatest/movies/resourses/test-data.sql";
    @Before
    public void setUp() throws SQLException {
        dataSource = new DriverManagerDataSource("jdbc:h2:mem:test;MODE=MYSQL", "sa", "sa");

        ScriptUtils.executeSqlScript(dataSource.getConnection(),new ClassPathResource(sqlPath));
...
public class MovieRepositoryIntegrationTest {
    ...
    private String sqlPath2 = "src/main/java/com/platzi/javatest/movies/resourses/test-data.sql";
    ...
    public void setUp() throws Exception {
       ...
       // ScriptUtils.executeSqlScript(dataSource.getConnection(), new ClassPathResource(sqlPath2));
