...
public class DateUtilTestShould {
    ...
    public void return_true_when_year_is_divisible_by_100_but_not_by_400(){
        ...
        assertThat(DateUtil.isLeapYear(1800),is(true));
        assertThat(DateUtil.isLeapYear(1900),is(true));
    }

    @Test
    public void return_true_when_year_is_divisible_by_4_but_is_not_divisible_by_100() {
    ...
    public void return_false_when_year_is_not_divisible_by_4(){
        ...
        assertThat(DateUtil.isLeapYear(2012),is(false));
    }
}