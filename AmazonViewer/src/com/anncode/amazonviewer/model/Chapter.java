...
public class Chapter extends Movie {
	...
	private Serie serie;
/** Constructor de la clases Chapter
 * 
 * @param title
 * @param genre
 * @param creator
 ...
 */
	...
	public void view() {
		// TODO Auto-generated method stub
		super.view();// calls Super class method view.
		ArrayList<Chapter> chapters = getSerie().getChapters();//create an array lis from the viewed Chapthers.
		int chapterViewCounter = 0; //Create a chapter viewed counter.
