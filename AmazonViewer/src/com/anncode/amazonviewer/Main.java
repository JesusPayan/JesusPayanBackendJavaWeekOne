...
public class Main {
	 ...
	 *  
	AmazonViewer
	 * Es un programa que permite visualizar Peliculas, Series con sus respectivos capitulos, leer libro y revistas
	 * permite generar reportes generales y por dia.
	 * <p>
	 * Existen algunas reglas como que todos su s elementop pueden ser visualizados o leido a excepcion de as revistas
	 * 
	...
	public static void main(String[] args) {
		...
		Film film = new Movie("","","",1,(short)1990);
		film.view();
		Film film2 = new Chapter("LOL", "COMIC", "EugenioDerbez", 1,(short) 2, 3, null);
